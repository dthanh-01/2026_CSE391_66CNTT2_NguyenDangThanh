...
console.log(tinhDiemTrungBinh(8, 7, 9)); // Kết quả sẽ là 8


//Viết thêm hàm `xepLoai(avg)` trong file JS:
...
let age1 =16;
kiemTraTuoi(age1); // Kết quả sẽ là "Chưa đủ 18 tuổi"
let age2 = 20;
kiemTraTuoi(age2); // Kết quả sẽ là "Đủ 18 tuổi"